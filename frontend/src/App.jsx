...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: 700, margin:"auto", padding:20 }} className={darkMode?"dark":"light"}>
      ...
      <ul>
        {transactions.map(t=>(
          <li key={t.id}>{t.type==="income"?"💵":"💸"} {t.title} - {t.amount} บาท ({t.category}) {t.date && `(${new Date(t.date).toLocaleString()})`}
